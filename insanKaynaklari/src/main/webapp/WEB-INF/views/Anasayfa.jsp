            ...
            <nav class="navbar navbar-default" role="navigation" data-spy="affix" data-offset-top="50">
              <div class="container">
                ...
                <div class="navbar-header">
                  ...
                  <a class="navbar-brand logo" href="${contextPath}/"><img src="resources/theme1/img/logo.png" alt=""></a>
                </div>
                ...
                <ul class="nav navbar-nav">
                  <li>
                    <a class="active" href="${contextPath}/">
                ...
                <ul class="nav navbar-nav navbar-right float-right">
                  <li class="left"><a href="${contextPath}/isveren/login"><i class="ti-pencil-alt"></i>İnsan Kaynakları</a></li>
                  <li class="right"><a href="${contextPath}/aday/login"><i class="ti-lock"></i>Aday</a></li>
                </ul>
              </div>                           
            </div>
            <!-- Mobile Menu Start -->
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="job-list">
              <div class="thumb">
                <a href="job-details.html"><img src="resources/theme1/img/jobs/img-2.jpg" alt=""></a>
              </div>
              <div class="job-list-content">
            ...
            <div class="job-list">
              <div class="thumb">
                <a href="job-details.html"><img src="resources/theme1/img/jobs/img-3.jpg" alt=""></a>
              </div>
              <div class="job-list-content">
            ...
            <div class="job-list">
              <div class="thumb">
                <a href="job-details.html"><img src="resources/theme1/img/jobs/img-4.jpg" alt=""></a>
              </div>
              <div class="job-list-content">
                ...
                <div class="featured-inner">
                  <figure class="item-thumb">
                    <a class="hover-effect" href="job-page.html">
                      <img src="resources/theme1/img/features/img-1.jpg" alt="">
                    </a>
                  </figure>
                  <div class="item-body">
            ...
            <div class="featured-item">
              <div class="featured-wrap">
                <div class="featured-inner">
                  <figure class="item-thumb">
                    <a class="hover-effect" href="job-page.html">
                      <img src="resources/theme1/img/features/img-2.jpg" alt="">
                    </a>
                  </figure>
                  <div class="item-body">
            ...
            <div class="featured-item">
              <div class="featured-wrap">
                <div class="featured-inner">
                  <figure class="item-thumb">
                    <a class="hover-effect" href="job-page.html">
                      <img src="resources/theme1/img/features/img-3.jpg" alt="">
                    </a>
                  </figure>
                  <div class="item-body">
        ...
        <div class="row">
          <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 blog-item">
            ...
            <div class="blog-item-wrapper">
              <div class="blog-item-img">
                <a href="single-post.html">
                  <img src="resources/theme1/img/blog/home-items/img1.jpg" alt="">
                </a>                
              </div>
          ...
          <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 blog-item">
            ...
            <div class="blog-item-wrapper">
              <div class="blog-item-img">
                <a href="single-post.html">
                  <img src="resources/theme1/img/blog/home-items/img2.jpg" alt="">
                </a>                
              </div>
              <div class="blog-item-text">
                <div class="meta-tags">
          ...
          <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 blog-item">
            ...
            <div class="blog-item-wrapper">
              <div class="blog-item-img">
                <a href="single-post.html">
                  <img src="resources/theme1/img/blog/home-items/img3.jpg" alt="">
                </a>                
              </div>
              <div class="blog-item-text">
                <div class="meta-tags">
        ...
        <div class="row">
          <div class="touch-slider" class="owl-carousel owl-theme">
            <div class="item active text-center">  
              <img class="img-member" src="resources/theme1/img/testimonial/img1.jpg" alt=""> 
            ...
            <div class="item text-center">
              <img class="img-member" src="resources/theme1/img/testimonial/img2.jpg" alt=""> 
              <div class="client-info">
            ...
            <div class="item text-center">
              <img class="img-member" src="resources/theme1/img/testimonial/img3.jpg" alt=""> 
              <div class="client-info">
